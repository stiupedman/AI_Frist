...
-- 初始化-部门表数据
-- ----------------------------
insert into sys_dept values(100,  0,   '0',          '家教平台',     0, '管理员', '15888888888', 'admin@example.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(101,  100, '0,100',      '教学服务中心', 1, '管理员', '15888888888', 'admin@example.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(102,  100, '0,100',      '运营管理中心', 2, '管理员', '15888888888', 'admin@example.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(103,  101, '0,100,101',  '平台研发部',   1, '管理员', '15888888888', 'admin@example.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(104,  101, '0,100,101',  '市场推广部',   2, '管理员', '15888888888', 'admin@example.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(105,  101, '0,100,101',  '教员服务部',   3, '管理员', '15888888888', 'admin@example.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(106,  101, '0,100,101',  '财务部',       4, '管理员', '15888888888', 'admin@example.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(107,  101, '0,100,101',  '运维部',       5, '管理员', '15888888888', 'admin@example.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(108,  102, '0,100,102',  '家长服务部',   1, '管理员', '15888888888', 'admin@example.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(109,  102, '0,100,102',  '质量管理部',   2, '管理员', '15888888888', 'admin@example.com', '0', '0', 'admin', sysdate(), '', null);
...
-- 初始化-用户信息表数据
-- ----------------------------
insert into sys_user values(1,  103, 'admin', '管理员', '00', 'admin@example.com', '15888888888', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', sysdate(), sysdate(), 'admin', sysdate(), '', null, '平台管理员');
...
-- 初始化-公告信息表数据
-- ----------------------------
insert into sys_notice values('1', '欢迎使用大学生家教管理系统', '2', '请根据身份进入家教工作台处理业务。', '0', 'admin', sysdate(), '', null, '管理员');
insert into sys_notice values('2', '系统维护通知', '1', '系统维护期间部分功能可能暂时不可用。', '0', 'admin', sysdate(), '', null, '管理员');
